...
Deno.test('Basic Token Test', () => {
  ...
  assertEquals(primaryToken.toJsToken(), 'export const colorPrimary = \'var(--color-primary)\'')
...
Deno.test('Nested tokens', () => {
  ...
  assertEquals(secondaryToken.toJsToken(), 'export const colorSecondary = \'var(--color-secondary)\'')
